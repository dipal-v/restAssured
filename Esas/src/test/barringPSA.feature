...
Feature: Barring of terminal by PSA
  ...
  Scenario: PSA should be able to BAR a terminal - Canada
  ...
  Scenario: PSA should be able to BAR a terminal
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
  ...
  Scenario: PSA should be able to activate and then Bar terminal for USA based customer.
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
  ...
  Scenario: PSA should be able to activate and then Bar terminal for AUSTRALIA based customer.
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
  ...
  Scenario: PSA should be able to activate and then Bar terminal for UK based customer.
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
