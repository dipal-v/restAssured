...
Feature: Change Account Authority by PSA
  ...
  Scenario: SAM should be able to change Account Authority - Canada
  ...
  Scenario: SAM should be able to change Account Authority - USA
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
  ...
  Scenario: SAM should be able to change Account Authority - AUSTRALIA
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
  ...
  Scenario: SAM should be able to change Account Authority - UK
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
