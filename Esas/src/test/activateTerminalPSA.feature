...
Feature: Activation of Terminal by PSA
  Background: : PSA can login with valid credentials
    ...
    @dipal
    Scenario: PSA should be able to activate a terminal with different AA Code - Canada
      Given Sam is on home page
      When He selects New Activation
      Then He should see 'Account Verification (T20)'
      When He selects forward
      Then He should go to the 'New Registration (T20)' page
      When He selects forward
  ...
  Scenario: PSA should be able to activate a terminal - Canada
    Given Sam is on home page
    When He selects New Activation
    ...
    Scenario: PSA should be able to activate terminal for USA based customer.
      Given Sam is on home page
      When He selects New Activation
      Then He should see 'New Registration (T20)'
      When He selects forward
  ...
  Scenario: PSA should be able to activate terminal for AUSTRALIA based customer.
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
  ...
  Scenario: PSA should be able to activate terminal for UK based customer.
    Given Sam is on home page
    When He selects New Activation
    Then He should see 'New Registration (T20)'
    When He selects forward
  ...
  Scenario: PSA should be able to activate terminal from template - UK based customer.
